      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('Item.itemtable') }}" aria-expanded="false">
                <span>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
              <img class="col-xl-4" src="../assets/images/profile/person.png" alt="" height="280px" style="width: 180px;">
            </div>
				</div>
        <!--  Row 3 -->
        <div class="row">
