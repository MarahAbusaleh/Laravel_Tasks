                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="{{ route('Item.index') }}">All Products</a></li>
                        ...
                        <div class="thumb">
                            <div class="inner-content">
                                ...
                                <div class="main-border-button">
                                    <a href="{{ route('Category.create') }}">Buy Now!</a>
                                </div>
                            </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <p>{{ $category-> desc }}</p>
                                                <div class="main-border-button">
                                                    <a href="{{ route('Category.show', $category->id) }}">All Products</a>
                                                </div>
                                                <br>                                                
                                            </div>
                                        </div>
